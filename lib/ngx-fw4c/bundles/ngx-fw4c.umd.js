(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common/http'), require('rxjs'), require('rxjs/operators'), require('lodash'), require('@angular/platform-browser'), require('ngx-bootstrap'), require('ng4-loading-spinner'), require('ngx-bootstrap/modal'), require('@angular/common'), require('@angular/forms'), require('@angular/router'), require('@angular/animations'), require('ng2-currency-mask'), require('ng2-currency-mask/src/currency-mask.config'), require('ng-pick-datetime'), require('@angular/platform-browser/animations'), require('@ckeditor/ckeditor5-build-classic'), require('ngx-image-cropper'), require('@ckeditor/ckeditor5-angular'), require('@ng-select/ng-select'), require('ng-click-outside'), require('igniteui-angular'), require('ngx-pipes'), require('@swimlane/ngx-dnd'), require('ngx-chips'), require('angular-tree-component')) :
    typeof define === 'function' && define.amd ? define('ngx-fw4c', ['exports', '@angular/core', '@angular/common/http', 'rxjs', 'rxjs/operators', 'lodash', '@angular/platform-browser', 'ngx-bootstrap', 'ng4-loading-spinner', 'ngx-bootstrap/modal', '@angular/common', '@angular/forms', '@angular/router', '@angular/animations', 'ng2-currency-mask', 'ng2-currency-mask/src/currency-mask.config', 'ng-pick-datetime', '@angular/platform-browser/animations', '@ckeditor/ckeditor5-build-classic', 'ngx-image-cropper', '@ckeditor/ckeditor5-angular', '@ng-select/ng-select', 'ng-click-outside', 'igniteui-angular', 'ngx-pipes', '@swimlane/ngx-dnd', 'ngx-chips', 'angular-tree-component'], factory) :
    (global = global || self, factory(global['ngx-fw4c'] = {}, global.ng.core, global.ng.common.http, global.rxjs, global.rxjs.operators, global.lodash, global.ng.platformBrowser, global['ngx-bootstrap'], global['ng4-loading-spinner'], global['ngx-bootstrap/modal'], global.ng.common, global.ng.forms, global.ng.router, global.ng.animations, global['ng2-currency-mask'], global['ng2-currency-mask/src/currency-mask'].config, global['ng-pick-datetime'], global.ng.platformBrowser.animations, global['@ckeditor/ckeditor5-build-classic'], global['ngx-image-cropper'], global['@ckeditor/ckeditor5-angular'], global['@ng-select/ng-select'], global['ng-click-outside'], global['igniteui-angular'], global['ngx-pipes'], global.ngxDnd, global['ngx-chips'], global['angular-tree-component']));
}(this, function (exports, core, http, rxjs, operators, lodash, platformBrowser, ngxBootstrap, ng4LoadingSpinner, modal, common, forms, router, animations, ng2CurrencyMask, currencyMask_config, ngPickDatetime, animations$1, Editor, ngxImageCropper, ckeditor5Angular, ngSelect, ngClickOutside, igniteuiAngular, ngxPipes, ngxDnd, ngxChips, angularTreeComponent) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var ValidationService = /** @class */ (function () {
        ...
        function (element, option) {
            var _this = this;
            /** @type {?} */
            var errors$ = [this.validateElement(element, option).pipe(operators.map((/**
                 * @param {?} newOption
                 * @return {?}
                 */
                    ...
                    var _loop_1 = function (i) {
                        ...
                        if (attributes && attributes.length > 0) {
                            if (attributes[_this.attributeName].value == item) {
                                ...
                                if (option) {
                                    _this.validateElement(_this.elements[i], option, true).pipe(operators.map((/**
                                     * @param {?} newOption
                                     * @return {?}
                                     */
                                    function (newOption) { return option = newOption; })), operators.map((/**
        ...
        function (item) {
            ...
            function (current) {
                ...
                function (element, index) {
                    ...
                    return __assign({}, current, { validationId: validationId, itemRef: item, valueResolver: current.valueResolver
                            ? (/**
                             * @param {?} payload
                             * @return {?}
                             */
        ...
        /** @nocollapse */ ValidationService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function ValidationService_Factory() { return new ValidationService(core.ɵɵinject(core.RendererFactory2), core.ɵɵinject(ValidationProvider), core.ɵɵinject(DataService), core.ɵɵinject(ActionService), core.ɵɵinject(AggregatorService)); }, token: ValidationService, providedIn: "root" });
    ...
    var MockService = /** @class */ (function () {
        ...
        function (callback, response) {
            ...
            if (mock)
                return rxjs.of(response ? response : (/** @type {?} */ ({}))).pipe(operators.delay(500));
            return callback;
        };
        /**
         * @private
    ...
    var TemplateComponent = /** @class */ (function () {
        ...
        TemplateComponent.propDecorators = {
            loader: [{ type: core.ViewChild, args: ['loader', { static: false },] }]
        };
    ...
    var KeyConst = /** @class */ (function () {
        ...
        KeyConst.LoggedIn = 'LOGGED_IN';
        KeyConst.SignOut = 'SIGN_OUT';
        KeyConst.Menu = 'MENU';
        KeyConst.AuthApi = 'AUTH_API';
        KeyConst.KeywordChanged = 'KEYWORD_CHANGED';
        KeyConst.Search = 'SEARCH';
        return KeyConst;
    }());
    if (false) {
        /** @type {?} */
     ...
     */
    /** @type {?} */
    var declarations$2 = [FormComponent, FormDirectorComponent, FormItemDirective, FormDirectorExtraItemDirective];
    ...
    var AuthModule = /** @class */ (function () {
        ...
        AuthModule.decorators = [
            { type: core.NgModule, args: [{
                        ...
                        entryComponents: declarations$3,
     ...
     */
    /** @type {?} */
    var declarations$5 = [DatetimePickerComponent, DaterangePickerComponent];
    ...
    var DefaultFooterComponent = /** @class */ (function () {
        ...
        DefaultFooterComponent.decorators = [
            { type: core.Component, args: [{
                        ...
                        styles: [".katana-footer{text-align:center;background-color:#1d9ce7}"]
                    }] }
        ];
        /** @nocollapse */
        DefaultFooterComponent.ctorParameters = function () { return []; };
        DefaultFooterComponent.propDecorators = {
            template: [{ type: core.Input }]
        };
    ...
    if (false) {
        /** @type {?} */
        DefaultFooterComponent.prototype.template;
    }
    ...
    var DefaultHeaderComponent = /** @class */ (function () {
        ...
        DefaultHeaderComponent.propDecorators = {
            ...
            menuTabs: [{ type: core.Input }],
            data: [{ type: core.Input }],
            menu: [{ type: core.ViewChild, args: ['menu', { static: true },] }]
        };
    ...
    var TableComponent = /** @class */ (function () {
        ...
        function (fileName, callback) {
            ...
            if (search) {
                ...
                function (response) {
                    ...
                    _this.excelExporterService.exportData(data, new igniteuiAngular.IgxExcelExporterOptions(fileName ? fileName : new Date().getTime().toString()));
                    if (callback)
                        callback();
                }));
            }
        ...
        TableComponent.ctorParameters = function () { return [
            ...
            { type: DataService },
            { type: ValidationService },
            { type: igniteuiAngular.IgxExcelExporterService }
        ]; };
    ...
    var ChipComponent = /** @class */ (function () {
        ...
        ChipComponent.propDecorators = {
            ...
            validationScope: [{ type: core.Input }],
            emitNullOnDestroy: [{ type: core.Input }],
            validationService: [{ type: core.Input }],
            modelChange: [{ type: core.Output }],
    ...
    var TreeViewModule = /** @class */ (function () {
        ...
        TreeViewModule.decorators = [
            { type: core.NgModule, args: [{
                        ...
                        imports: [
                            common.CommonModule,
                            angularTreeComponent.TreeModule.forRoot()
                        ],
    ...
    var Framework4CModule = /** @class */ (function () {
        ...
        function () {
            return {
                ...
                providers: [
                    AggregatorService,
                    igniteuiAngular.IgxExcelExporterService
                ]
            };
        };
    ...
    exports.ChangedCell = ChangedCell;
    exports.ChangedItem = ChangedItem;
    exports.ChangedRow = ChangedRow;
