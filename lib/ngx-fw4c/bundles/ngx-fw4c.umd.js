(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common/http'), require('rxjs'), require('rxjs/operators'), require('lodash'), require('@angular/platform-browser'), require('ngx-bootstrap'), require('@angular/common'), require('@angular/forms'), require('ng4-loading-spinner'), require('ngx-bootstrap/modal'), require('@angular/router'), require('@angular/animations'), require('@ckeditor/ckeditor5-build-classic'), require('@ng-select/ng-select'), require('ng2-currency-mask'), require('ng2-currency-mask/src/currency-mask.config'), require('ngx-pipes'), require('ng-pick-datetime'), require('@ckeditor/ckeditor5-angular'), require('@angular/platform-browser/animations'), require('ng-click-outside')) :
    typeof define === 'function' && define.amd ? define('ngx-fw4c', ['exports', '@angular/core', '@angular/common/http', 'rxjs', 'rxjs/operators', 'lodash', '@angular/platform-browser', 'ngx-bootstrap', '@angular/common', '@angular/forms', 'ng4-loading-spinner', 'ngx-bootstrap/modal', '@angular/router', '@angular/animations', '@ckeditor/ckeditor5-build-classic', '@ng-select/ng-select', 'ng2-currency-mask', 'ng2-currency-mask/src/currency-mask.config', 'ngx-pipes', 'ng-pick-datetime', '@ckeditor/ckeditor5-angular', '@angular/platform-browser/animations', 'ng-click-outside'], factory) :
    (global = global || self, factory(global['ngx-fw4c'] = {}, global.ng.core, global.ng.common.http, global.rxjs, global.rxjs.operators, global.lodash, global.ng.platformBrowser, global['ngx-bootstrap'], global.ng.common, global.ng.forms, global['ng4-loading-spinner'], global['ngx-bootstrap/modal'], global.ng.router, global.ng.animations, global['@ckeditor/ckeditor5-build-classic'], global['@ng-select/ng-select'], global['ng2-currency-mask'], global['ng2-currency-mask/src/currency-mask'].config, global['ngx-pipes'], global['ng-pick-datetime'], global['@ckeditor/ckeditor5-angular'], global.ng.platformBrowser.animations, global['ng-click-outside']));
}(this, function (exports, core, http, rxjs, operators, lodash, platformBrowser, ngxBootstrap, common, forms, ng4LoadingSpinner, modal, router, animations, Editor, ngSelect, ng2CurrencyMask, currencyMask_config, ngxPipes, ngPickDatetime, ckeditor5Angular, animations$1, ngClickOutside) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var ValidationRule = /** @class */ (function () {
        ...
        /** @nocollapse */ ValidationRule.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function ValidationRule_Factory() { return new ValidationRule(); }, token: ValidationRule, providedIn: "root" });
    ...
    var ValidationService = /** @class */ (function () {
        ...
        function (element, option) {
            ...
            function (action) {
                ...
                switch (action.key) {
                    case ValidationConstant.Required: {
                        return _this.validationRule.required(fieldValue).pipe(operators.map((/**
                         * @param {?} isValid
                         * @return {?}
                         */
                        function (isValid) {
                    ...
                    case ValidationConstant.Email: {
                        return _this.validationRule.email(fieldValue).pipe(operators.map((/**
                         * @param {?} isValid
                         * @return {?}
                         */
                        function (isValid) {
                    ...
                    case ValidationConstant.Phone: {
                        return _this.validationRule.phone(fieldValue).pipe(operators.map((/**
                         * @param {?} isValid
                         * @return {?}
                         */
                        function (isValid) {
        ...
        /** @nocollapse */ ValidationService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function ValidationService_Factory() { return new ValidationService(core.ɵɵinject(core.RendererFactory2), core.ɵɵinject(DataService), core.ɵɵinject(ActionService), core.ɵɵinject(ValidationRule)); }, token: ValidationService, providedIn: "root" });
    ...
    var FileService = /** @class */ (function (_super) {
        ...
        /** @nocollapse */ FileService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function FileService_Factory() { return new FileService(core.ɵɵinject(http.HttpClient)); }, token: FileService, providedIn: "root" });
        return FileService;
    }(MockService));
    if (false) {
        /**
    ...
    exports.CustomValidationAction = CustomValidationAction;
    ...
    exports.EmailValidationAction = EmailValidationAction;
    ...
    exports.PhoneValidationAction = PhoneValidationAction;
    ...
    exports.RequiredValidationAction = RequiredValidationAction;
