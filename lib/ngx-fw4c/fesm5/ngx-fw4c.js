import { Injectable, ɵɵdefineInjectable, ɵɵinject, EventEmitter, RendererFactory2, Output, NgModule, Component, ViewEncapsulation, ComponentFactoryResolver, ViewContainerRef, Input, ViewChild, Pipe, TemplateRef, ContentChildren, Directive, ContentChild, ChangeDetectorRef, Inject, HostBinding, HostListener, ElementRef } from '@angular/core';
...
import { debounceTime, map, take, defaultIfEmpty, delay, finalize, tap, distinctUntilChanged, switchMap, concat, skip, filter } from 'rxjs/operators';
import { isEqual } from 'lodash';
import { DomSanitizer, BrowserModule } from '@angular/platform-browser';
import { BsModalRef, BsModalService, BsDropdownModule, ComponentLoaderFactory, PositioningService, ModalModule } from 'ngx-bootstrap';
...
var ValidationService = /** @class */ (function () {
    ...
    /** @nocollapse */ ValidationService.ngInjectableDef = ɵɵdefineInjectable({ factory: function ValidationService_Factory() { return new ValidationService(ɵɵinject(RendererFactory2), ɵɵinject(ValidationProvider), ɵɵinject(DataService), ɵɵinject(ActionService), ɵɵinject(AggregatorService)); }, token: ValidationService, providedIn: "root" });
